# PutChannelsChannelHashedIdCategory1
...
```typescript
import { PutChannelsChannelHashedIdCategory1 } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdCategory1 = "comedy > comedy_interviews";
```
