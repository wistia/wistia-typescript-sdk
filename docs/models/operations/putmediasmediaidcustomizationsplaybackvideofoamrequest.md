...
```typescript
import { PutMediasMediaIdCustomizationsPlaybackVideoFoamRequest } from "@wistia/wistia-api-client/models/operations";

let value: PutMediasMediaIdCustomizationsPlaybackVideoFoamRequest = {};
```
