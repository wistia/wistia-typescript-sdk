...
```typescript
import { GetMediaExtendedAudioDescriptionsIdMedia } from "@wistia/wistia-api-client/models/operations";

let value: GetMediaExtendedAudioDescriptionsIdMedia = {
  id: "<id>",
  indexUrl: "https://tired-lamp.net",
  url: "https://secondary-sideboard.net/",
};
```
