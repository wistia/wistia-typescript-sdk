...
```typescript
import { PostChannelsCategory2Response } from "@wistia/wistia-api-client/models/operations";

let value: PostChannelsCategory2Response = "comedy > stand_up";
```
