# DeleteWebinarsIdLifecycleStatus
...
```typescript
import { DeleteWebinarsIdLifecycleStatus } from "@wistia/wistia-api-client/models/operations";

let value: DeleteWebinarsIdLifecycleStatus = "ready";
```
