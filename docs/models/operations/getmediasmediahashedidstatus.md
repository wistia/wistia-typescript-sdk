...
```typescript
import { GetMediasMediaHashedIdStatus } from "@wistia/wistia-api-client/models/operations";

let value: GetMediasMediaHashedIdStatus = "failed";
```
