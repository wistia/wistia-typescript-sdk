# PostMediasMediaHashedIdCopyStatus
...
```typescript
import { PostMediasMediaHashedIdCopyStatus } from "@wistia/wistia-api-client/models/operations";

let value: PostMediasMediaHashedIdCopyStatus = "queued";
```
