# PutChannelsChannelHashedIdLanguageRequest
...
```typescript
import { PutChannelsChannelHashedIdLanguageRequest } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdLanguageRequest = "es-do";
```
