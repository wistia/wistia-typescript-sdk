...
```typescript
import { DeleteChannelsChannelHashedIdCategory3 } from "@wistia/wistia-api-client/models/operations";

let value: DeleteChannelsChannelHashedIdCategory3 = "science > chemistry";
```
