...
```typescript
import { PostCustomMetadataFieldDefinitionsConfigRequest2 } from "@wistia/wistia-api-client/models/operations";

let value: PostCustomMetadataFieldDefinitionsConfigRequest2 = {
