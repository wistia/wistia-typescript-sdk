...
```typescript
import { PostChannelsChannelHashedIdCollaboratorsShare } from "@wistia/wistia-api-client/models/operations";

let value: PostChannelsChannelHashedIdCollaboratorsShare = {
  id: 3,
  name: "Jim",
  type: "Contact",
