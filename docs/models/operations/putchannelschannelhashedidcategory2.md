# PutChannelsChannelHashedIdCategory2
...
```typescript
import { PutChannelsChannelHashedIdCategory2 } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdCategory2 = "leisure > home_and_garden";
```
