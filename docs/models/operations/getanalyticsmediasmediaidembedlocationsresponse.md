...
| `uniqueLoads`                                                                  | *number*                                                                       | :heavy_minus_sign:                                                             | The number of unique video loads from this location (one per visitor session). |
| `plays`                                                                        | *number*                                                                       | :heavy_minus_sign:                                                             | The number of video plays from this location.                                  |
| `uniquePlays`                                                                  | *number*                                                                       | :heavy_minus_sign:                                                             | The number of unique video plays from this location (one per visitor session). |
