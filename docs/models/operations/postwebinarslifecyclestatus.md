...
```typescript
import { PostWebinarsLifecycleStatus } from "@wistia/wistia-api-client/models/operations";

let value: PostWebinarsLifecycleStatus = "ready";
```
