...
| `backgroundJobStatus`                                                                                            | [operations.PutMediasRestoreBackgroundJobStatus](../../models/operations/putmediasrestorebackgroundjobstatus.md) | :heavy_minus_sign:                                                                                               | Status of the background job.                                                                                    |