...
```typescript
import { PostChannelsCategory1Request } from "@wistia/wistia-api-client/models/operations";

let value: PostChannelsCategory1Request = "science > life_sciences";
```
