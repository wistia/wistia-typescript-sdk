...
```typescript
import { PutWebinarsIdFolder } from "@wistia/wistia-api-client/models/operations";

let value: PutWebinarsIdFolder = {
  id: "<id>",
  indexUrl: "https://cheerful-footrest.info/",
  url: "https://whirlwind-armchair.net/",
};
```
