# GetFoldersFolderIdSubfoldersSubfolderIdStatus
...
```typescript
import { GetFoldersFolderIdSubfoldersSubfolderIdStatus } from "@wistia/wistia-api-client/models/operations";

let value: GetFoldersFolderIdSubfoldersSubfolderIdStatus = "ready";
```
