...
```typescript
import { DeleteProjectsProjectIdSharingsSharingIdShare } from "@wistia/wistia-api-client/models/operations";

let value: DeleteProjectsProjectIdSharingsSharingIdShare = {
  id: 3,
  name: "Jim",
  type: "Contact",
