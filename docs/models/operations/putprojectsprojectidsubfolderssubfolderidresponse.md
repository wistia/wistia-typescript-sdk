...
```typescript
import { PutProjectsProjectIdSubfoldersSubfolderIdResponse } from "@wistia/wistia-api-client/models/operations";

let value: PutProjectsProjectIdSubfoldersSubfolderIdResponse = {
  hashedId: "abc123def4",
