...
```typescript
import { GetChannelsChannelHashedIdCollaboratorsShare } from "@wistia/wistia-api-client/models/operations";

let value: GetChannelsChannelHashedIdCollaboratorsShare = {
  id: 3,
  name: "Jim",
  type: "Contact",
