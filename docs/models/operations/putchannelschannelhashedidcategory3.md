# PutChannelsChannelHashedIdCategory3
...
```typescript
import { PutChannelsChannelHashedIdCategory3 } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdCategory3 =
