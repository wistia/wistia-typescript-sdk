...
```typescript
import { WebinarFolder } from "@wistia/wistia-api-client/models/operations";

let value: WebinarFolder = {
  id: "<id>",
  indexUrl: "https://velvety-devastation.info/",
  url: "https://inexperienced-pick.info/",
};
```
