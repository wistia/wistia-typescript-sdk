# GetChannelsChannelHashedIdCategory3
...
```typescript
import { GetChannelsChannelHashedIdCategory3 } from "@wistia/wistia-api-client/models/operations";

let value: GetChannelsChannelHashedIdCategory3 = "business > non_profit";
```
