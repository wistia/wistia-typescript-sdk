...
```typescript
import { DeleteWebinarsIdFolder } from "@wistia/wistia-api-client/models/operations";

let value: DeleteWebinarsIdFolder = {
  id: "<id>",
  indexUrl: "https://granular-formation.org",
  url: "https://busy-atrium.net",
};
```
