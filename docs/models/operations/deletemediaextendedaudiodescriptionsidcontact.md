...
```typescript
import { DeleteMediaExtendedAudioDescriptionsIdContact } from "@wistia/wistia-api-client/models/operations";

let value: DeleteMediaExtendedAudioDescriptionsIdContact = {
  id: "<id>",
  indexUrl: "https://weighty-pension.info/",
  url: "https://remarkable-bandwidth.com",
};
```
