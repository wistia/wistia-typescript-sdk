...
```typescript
import { DeleteChannelsChannelHashedIdCollaboratorsIdShare } from "@wistia/wistia-api-client/models/operations";

let value: DeleteChannelsChannelHashedIdCollaboratorsIdShare = {
  id: 3,
  name: "Jim",
  type: "Contact",
