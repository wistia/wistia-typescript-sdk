# PutChannelsChannelHashedIdCategory2Request
...
```typescript
import { PutChannelsChannelHashedIdCategory2Request } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdCategory2Request = "arts > books";
```
