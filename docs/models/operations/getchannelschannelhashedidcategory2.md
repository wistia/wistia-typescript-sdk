# GetChannelsChannelHashedIdCategory2
...
```typescript
import { GetChannelsChannelHashedIdCategory2 } from "@wistia/wistia-api-client/models/operations";

let value: GetChannelsChannelHashedIdCategory2 = "sports > baseball";
```
