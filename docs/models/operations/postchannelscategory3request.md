...
```typescript
import { PostChannelsCategory3Request } from "@wistia/wistia-api-client/models/operations";

let value: PostChannelsCategory3Request = "business > non_profit";
```
