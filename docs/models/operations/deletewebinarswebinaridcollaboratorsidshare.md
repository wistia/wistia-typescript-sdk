...
```typescript
import { DeleteWebinarsWebinarIdCollaboratorsIdShare } from "@wistia/wistia-api-client/models/operations";

let value: DeleteWebinarsWebinarIdCollaboratorsIdShare = {
  id: 3,
  name: "Jim",
  type: "Contact",
