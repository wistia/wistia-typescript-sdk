# GetShareLinksIdentifierVisibility
...
```typescript
import { GetShareLinksIdentifierVisibility } from "@wistia/wistia-api-client/models/operations";

let value: GetShareLinksIdentifierVisibility = "account";
```
