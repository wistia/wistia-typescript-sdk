...
```typescript
import { DeleteChannelsChannelHashedIdCategory2 } from "@wistia/wistia-api-client/models/operations";

let value: DeleteChannelsChannelHashedIdCategory2 = "sports > hockey";
```
