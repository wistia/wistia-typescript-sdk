...
```typescript
import { PostChannelsCategory3Response } from "@wistia/wistia-api-client/models/operations";

let value: PostChannelsCategory3Response = "business > non_profit";
```
