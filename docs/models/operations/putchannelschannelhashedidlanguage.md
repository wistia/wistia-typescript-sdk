# PutChannelsChannelHashedIdLanguage
...
```typescript
import { PutChannelsChannelHashedIdLanguage } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdLanguage = "ru";
```
