...
```typescript
import { GetWebinarsFolder } from "@wistia/wistia-api-client/models/operations";

let value: GetWebinarsFolder = {
  id: "<id>",
  indexUrl: "https://tricky-blowgun.biz/",
  url: "https://cautious-asset.name/",
};
```
