# PutChannelsChannelHashedIdCategory1Request
...
```typescript
import { PutChannelsChannelHashedIdCategory1Request } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdCategory1Request = "arts > books";
```
