# GetChannelsChannelHashedIdLanguage
...
```typescript
import { GetChannelsChannelHashedIdLanguage } from "@wistia/wistia-api-client/models/operations";

let value: GetChannelsChannelHashedIdLanguage = "es-ve";
```
