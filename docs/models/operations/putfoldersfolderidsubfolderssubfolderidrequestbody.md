...
```typescript
import { PutFoldersFolderIdSubfoldersSubfolderIdRequestBody } from "@wistia/wistia-api-client/models/operations";

let value: PutFoldersFolderIdSubfoldersSubfolderIdRequestBody = {
