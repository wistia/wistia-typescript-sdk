...
| `personalLibrary`                                                                                                                    | *boolean*                                                                                                                            | :heavy_minus_sign:                                                                                                                   | When true, creates the folder inside the requesting user's personal "My Library" (owned by them) instead of a shared account folder. | false                                                                                                                                |