# GetChannelsChannelHashedIdCategory1
...
```typescript
import { GetChannelsChannelHashedIdCategory1 } from "@wistia/wistia-api-client/models/operations";

let value: GetChannelsChannelHashedIdCategory1 = "tv_and_film > film_history";
```
