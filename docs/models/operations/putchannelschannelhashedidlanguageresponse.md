# PutChannelsChannelHashedIdLanguageResponse
...
```typescript
import { PutChannelsChannelHashedIdLanguageResponse } from "@wistia/wistia-api-client/models/operations";

let value: PutChannelsChannelHashedIdLanguageResponse = "be";
```
