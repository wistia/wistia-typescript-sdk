...
```typescript
import { GetChannelsCategory3 } from "@wistia/wistia-api-client/models/operations";

let value: GetChannelsCategory3 = "tv_and_film > film_reviews";
```
