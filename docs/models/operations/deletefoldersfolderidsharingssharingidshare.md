...
```typescript
import { DeleteFoldersFolderIdSharingsSharingIdShare } from "@wistia/wistia-api-client/models/operations";

let value: DeleteFoldersFolderIdSharingsSharingIdShare = {
  id: 3,
  name: "Jim",
  type: "Contact",
