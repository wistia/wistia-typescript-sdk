...
```typescript
import { PostChannelsLanguageResponse } from "@wistia/wistia-api-client/models/operations";

let value: PostChannelsLanguageResponse = "af";
```
