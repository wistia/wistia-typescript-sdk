...
```typescript
import { GetChannelEpisodesPodcastSettings } from "@wistia/wistia-api-client/models/operations";

let value: GetChannelEpisodesPodcastSettings = {};
```
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `episodeType`                                                                                        | [operations.GetChannelEpisodesEpisodeType](../../models/operations/getchannelepisodesepisodetype.md) | :heavy_minus_sign:                                                                                   | The type of episode.                                                                                 |
