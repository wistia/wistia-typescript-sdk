# GetMediasMediaIdShareLinkVisibility
...
```typescript
import { GetMediasMediaIdShareLinkVisibility } from "@wistia/wistia-api-client/models/operations";

let value: GetMediasMediaIdShareLinkVisibility = "locked";
```
