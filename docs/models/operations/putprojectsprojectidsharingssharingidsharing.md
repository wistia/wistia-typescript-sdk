...
```typescript
import { PutProjectsProjectIdSharingsSharingIdSharing } from "@wistia/wistia-api-client/models/operations";

let value: PutProjectsProjectIdSharingsSharingIdSharing = {};
```
