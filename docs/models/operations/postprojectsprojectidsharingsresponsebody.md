...
```typescript
import { PostProjectsProjectIdSharingsResponseBody } from "@wistia/wistia-api-client/models/operations";

let value: PostProjectsProjectIdSharingsResponseBody = {
...
| `sharing`                                                                | [operations.SharingResponse](../../models/operations/sharingresponse.md) | :heavy_minus_sign:                                                       | N/A                                                                      |                                                                          |