...
```typescript
import { DeleteMediaExtendedAudioDescriptionsIdProvidedMediaFile } from "@wistia/wistia-api-client/models/operations";

let value: DeleteMediaExtendedAudioDescriptionsIdProvidedMediaFile = {
  id: "<id>",
  indexUrl: "https://pessimistic-disk.com",
  url: "https://hopeful-quit.biz",
};
```
