...
```typescript
import { DeleteProjectsProjectIdSubfoldersSubfolderIdResponse } from "@wistia/wistia-api-client/models/operations";

let value: DeleteProjectsProjectIdSubfoldersSubfolderIdResponse = {
  hashedId: "abc123def4",
