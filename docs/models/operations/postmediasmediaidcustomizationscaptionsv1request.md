...
```typescript
import { PostMediasMediaIdCustomizationsCaptionsV1Request } from "@wistia/wistia-api-client/models/operations";

let value: PostMediasMediaIdCustomizationsCaptionsV1Request = {};
```
