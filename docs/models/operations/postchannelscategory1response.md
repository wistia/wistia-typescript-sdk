...
```typescript
import { PostChannelsCategory1Response } from "@wistia/wistia-api-client/models/operations";

let value: PostChannelsCategory1Response = "business > management";
```
