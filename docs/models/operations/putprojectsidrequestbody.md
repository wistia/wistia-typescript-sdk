...
```typescript
import { PutProjectsIdRequestBody } from "@wistia/wistia-api-client/models/operations";

let value: PutProjectsIdRequestBody = {
...
| `public`                                                     | *operations.PutProjectsIdPublicUnion*                        | :heavy_minus_sign:                                           | N/A                                                          |                                                              |