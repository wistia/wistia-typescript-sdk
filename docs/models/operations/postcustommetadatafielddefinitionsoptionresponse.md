...
```typescript
import { PostCustomMetadataFieldDefinitionsOptionResponse } from "@wistia/wistia-api-client/models/operations";

let value: PostCustomMetadataFieldDefinitionsOptionResponse = {
  key: "high",
  label: "High",
  position: 0,
};
