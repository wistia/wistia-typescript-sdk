...
```typescript
import { PostCustomMetadataFieldDefinitionsKeyRestoreOption } from "@wistia/wistia-api-client/models/operations";

let value: PostCustomMetadataFieldDefinitionsKeyRestoreOption = {
  key: "high",
  label: "High",
  position: 0,
};
