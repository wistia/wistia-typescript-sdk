...
async function run() {
  const result = await wistia.extendedAudioDescriptions.getMediaExtendedAudioDescriptions();
...
import { extendedAudioDescriptionsGetMediaExtendedAudioDescriptions } from "@wistia/wistia-api-client/funcs/extendedAudioDescriptionsGetMediaExtendedAudioDescriptions.js";
...
async function run() {
  const res = await extendedAudioDescriptionsGetMediaExtendedAudioDescriptions(wistia);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("extendedAudioDescriptionsGetMediaExtendedAudioDescriptions failed:", res.error);
  }
}
...
async function run() {
  const result = await wistia.extendedAudioDescriptions.getMediaExtendedAudioDescriptionsId({
    id: "<id>",
  });
...
```typescript
import { WistiaCore } from "@wistia/wistia-api-client/core.js";
import { extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsId } from "@wistia/wistia-api-client/funcs/extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsId.js";
...
async function run() {
  const res = await extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsId(wistia, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsId failed:", res.error);
  }
}
...
async function run() {
  const result = await wistia.extendedAudioDescriptions.deleteMediaExtendedAudioDescriptionsId({
    id: "<id>",
  });
...
```typescript
import { WistiaCore } from "@wistia/wistia-api-client/core.js";
import { extendedAudioDescriptionsDeleteMediaExtendedAudioDescriptionsId } from "@wistia/wistia-api-client/funcs/extendedAudioDescriptionsDeleteMediaExtendedAudioDescriptionsId.js";
...
async function run() {
  const res = await extendedAudioDescriptionsDeleteMediaExtendedAudioDescriptionsId(wistia, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("extendedAudioDescriptionsDeleteMediaExtendedAudioDescriptionsId failed:", res.error);
  }
}
...
async function run() {
  const result = await wistia.extendedAudioDescriptions.postMediaExtendedAudioDescriptionsOrder({
    mediaId: "<id>",
  });
...
```typescript
import { WistiaCore } from "@wistia/wistia-api-client/core.js";
import { extendedAudioDescriptionsPostMediaExtendedAudioDescriptionsOrder } from "@wistia/wistia-api-client/funcs/extendedAudioDescriptionsPostMediaExtendedAudioDescriptionsOrder.js";
...
async function run() {
  const res = await extendedAudioDescriptionsPostMediaExtendedAudioDescriptionsOrder(wistia, {
    mediaId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("extendedAudioDescriptionsPostMediaExtendedAudioDescriptionsOrder failed:", res.error);
  }
}
...
async function run() {
  const result = await wistia.extendedAudioDescriptions.getMediaExtendedAudioDescriptionsOrderStatusId({
    id: "<id>",
  });
...
```typescript
import { WistiaCore } from "@wistia/wistia-api-client/core.js";
import { extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsOrderStatusId } from "@wistia/wistia-api-client/funcs/extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsOrderStatusId.js";
...
async function run() {
  const res = await extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsOrderStatusId(wistia, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("extendedAudioDescriptionsGetMediaExtendedAudioDescriptionsOrderStatusId failed:", res.error);
  }
}
