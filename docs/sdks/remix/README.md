...
| errors.PostRemixesForbiddenError           | 403                                        | application/json                           |
...
| errors.PostRemixesRemixHashedIdContinueForbiddenError           | 403                                                             | application/json                                                |
...
| errors.PostRemixesRemixHashedIdExportForbiddenError           | 403                                                           | application/json                                              |
