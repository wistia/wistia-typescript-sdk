...
* [resolve](#resolve) - Resolve share link
...
<!-- UsageSnippet language="typescript" operationID="get_/share_links/{identifier}" method="get" path="/share_links/{identifier}" -->
```typescript
...
async function run() {
  const result = await wistia.shareLinks.resolve({
    identifier: "<value>",
  });
...
import { shareLinksResolve } from "@wistia/wistia-api-client/funcs/shareLinksResolve.js";
...
async function run() {
  const res = await shareLinksResolve(wistia, {
    identifier: "<value>",
  });
  if (res.ok) {
    ...
    console.log("shareLinksResolve failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetShareLinksIdentifierRequest](../../models/operations/getsharelinksidentifierrequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.GetShareLinksIdentifierResponse](../../models/operations/getsharelinksidentifierresponse.md)\>**

### Errors

| Error Type                                        | Status Code                                       | Content Type                                      |
| ------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- |
| errors.GetShareLinksIdentifierUnauthorizedError   | 401                                               | application/json                                  |
| errors.GetShareLinksIdentifierForbiddenError      | 403                                               | application/json                                  |
| errors.GetShareLinksIdentifierNotFoundError       | 404                                               | application/json                                  |
| errors.GetShareLinksIdentifierInternalServerError | 500                                               | application/json                                  |
