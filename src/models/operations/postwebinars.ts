 ...
 */
export const PostWebinarsLifecycleStatus = {
  Pending: "pending",
  Ready: "ready",
  Starting: "starting",
  Started: "started",
 ...
 * The current lifecycle status of the webinar. This is a read-only, system-managed field that Wistia updates as the event moves through its lifecycle; it cannot be set or changed via the API.
 */
export type PostWebinarsLifecycleStatus = ClosedEnum<
  typeof PostWebinarsLifecycleStatus
>;
...
export type PostWebinarsResponse = {
   ...
   * The current lifecycle status of the webinar. This is a read-only, system-managed field that Wistia updates as the event moves through its lifecycle; it cannot be set or changed via the API.
   */
  lifecycleStatus: PostWebinarsLifecycleStatus;
  /**
...
/** @internal */
export const PostWebinarsLifecycleStatus$inboundSchema: z.ZodNativeEnum<
  typeof PostWebinarsLifecycleStatus
> = z.nativeEnum(PostWebinarsLifecycleStatus);
...
> = z.object({
  ...
  time_zone: z.string(),
  lifecycle_status: PostWebinarsLifecycleStatus$inboundSchema,
