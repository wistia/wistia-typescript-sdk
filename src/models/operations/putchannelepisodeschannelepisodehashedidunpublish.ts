 ...
 */
export const PutChannelEpisodesChannelEpisodeHashedIdUnpublishPublishStatus = {
  Draft: "draft",
  Published: "published",
  Scheduled: "scheduled",
} as const;
 ...
 * The status of whether or not the episode has been published to your channel.
 */
export type PutChannelEpisodesChannelEpisodeHashedIdUnpublishPublishStatus =
  ClosedEnum<
    typeof PutChannelEpisodesChannelEpisodeHashedIdUnpublishPublishStatus
  >;
...
export type PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody = {
  /**
...
export type PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequest = {
  ...
  requestBody?:
    | PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody
    | undefined;
};
...
/** @internal */
export const PutChannelEpisodesChannelEpisodeHashedIdUnpublishPublishStatus$outboundSchema:
  z.ZodNativeEnum<
    typeof PutChannelEpisodesChannelEpisodeHashedIdUnpublishPublishStatus
  > = z.nativeEnum(
    PutChannelEpisodesChannelEpisodeHashedIdUnpublishPublishStatus,
...
/** @internal */
export const PutChannelEpisodesChannelEpisodeHashedIdUnpublishEpisodeType$outboundSchema:
  z.ZodNativeEnum<
    typeof PutChannelEpisodesChannelEpisodeHashedIdUnpublishEpisodeType
  > = z.nativeEnum(
    PutChannelEpisodesChannelEpisodeHashedIdUnpublishEpisodeType,
...
/** @internal */
export type PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody$Outbound =
  {
    description?: string | null | undefined;
    title?: string | null | undefined;
...
/** @internal */
export const PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody$outboundSchema:
  z.ZodType<
    PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody$Outbound,
    z.ZodTypeDef,
    PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody
  > = z.object({
    ...
    publishStatus:
      PutChannelEpisodesChannelEpisodeHashedIdUnpublishPublishStatus$outboundSchema
        .optional(),
    publishAt: z.date().transform(v => v.toISOString()).optional(),
    episodeNotes: z.string().optional(),
    episodeType:
      PutChannelEpisodesChannelEpisodeHashedIdUnpublishEpisodeType$outboundSchema
        .optional(),
...
export function putChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBodyToJSON(
  putChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody:
    PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody,
): string {
  return JSON.stringify(
    PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody$outboundSchema
      .parse(putChannelEpisodesChannelEpisodeHashedIdUnpublishRequestBody),
  );
}
