...
export const PostBulkResourceType = {
  ...
  Captions: "captions",
  CustomizationAccess: "customization_access",
  CustomizationAccessibility: "customization_accessibility",
  CustomizationAppearance: "customization_appearance",
  CustomizationChapters: "customization_chapters",
  CustomizationEngagement: "customization_engagement",
  CustomizationLeadCapture: "customization_lead_capture",
  CustomizationPlayback: "customization_playback",
  CustomizationRelatedMedia: "customization_related_media",
  CustomizationSharing: "customization_sharing",
  CustomizationThumbnail: "customization_thumbnail",
} as const;
/**
 * The type of resource to operate on. `folder` means a top-level folder
 *
...
export type PostBulkAction = {
  ...
  /**
   * The hashed ID of the resource. Required for update, delete, and move
   *
   * @remarks
   * operations.
   *
...
export type PostBulkRequest = {
  /**
   * An array of actions to process. Maximum 1000 actions per request, and
   *
   * @remarks
