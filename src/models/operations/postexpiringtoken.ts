...
export type PostExpiringTokenGlobals = {
  /**
   * The API version
   */
...
export type PostExpiringTokenRequestBody = {
...
export type PostExpiringTokenRequest = {
   ...
   */
  xWistiaAPIVersion?: string | undefined;
  requestBody?: PostExpiringTokenRequestBody | undefined;
};
...
/** @internal */
export type PostExpiringTokenRequestBody$Outbound = {
  expiring_access_token?: ExpiringAccessToken$Outbound | undefined;
};

/** @internal */
export const PostExpiringTokenRequestBody$outboundSchema: z.ZodType<
  PostExpiringTokenRequestBody$Outbound,
  z.ZodTypeDef,
  PostExpiringTokenRequestBody
> = z.object({
...
export function postExpiringTokenRequestBodyToJSON(
  postExpiringTokenRequestBody: PostExpiringTokenRequestBody,
): string {
  return JSON.stringify(
    PostExpiringTokenRequestBody$outboundSchema.parse(
      postExpiringTokenRequestBody,
    ),
  );
}
...
export type PostExpiringTokenRequest$Outbound = {
  ...
  RequestBody?: PostExpiringTokenRequestBody$Outbound | undefined;
};
...
> = z.object({
  ...
  requestBody: z.lazy(() => PostExpiringTokenRequestBody$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
