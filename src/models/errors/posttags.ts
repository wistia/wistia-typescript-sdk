 ...
 */
export type PostTagsForbiddenErrorData = {
  error?: string | undefined;
};
 ...
 * Forbidden, token is valid but account does not have access to feature
 */
export class PostTagsForbiddenError extends WistiaError {
  error?: string | undefined;

  /** The original data that was passed to this error instance. */
  data$: PostTagsForbiddenErrorData;

  constructor(
    err: PostTagsForbiddenErrorData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
    ...
    this.name = "PostTagsForbiddenError";
  }
}
...
/** @internal */
export const PostTagsForbiddenError$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  .transform((v) => {
    return new PostTagsForbiddenError(v, {
      request: v.request$,
      response: v.response$,
      body: v.body$,
    });
