 ...
 */
export type PutMediasMoveForbiddenErrorData = {
  error?: string | undefined;
};
 ...
 * Forbidden, token is valid but account does not have access to feature
 */
export class PutMediasMoveForbiddenError extends WistiaError {
  error?: string | undefined;

  /** The original data that was passed to this error instance. */
  data$: PutMediasMoveForbiddenErrorData;

  constructor(
    err: PutMediasMoveForbiddenErrorData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
    ...
    this.name = "PutMediasMoveForbiddenError";
  }
}
...
export type PutMediasMoveUnauthorizedErrorData = {
   ...
   */
  code?: operations.PutMediasMoveCode | undefined;
  error?: string | undefined;
};
...
/** @internal */
export const PutMediasMoveForbiddenError$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  .transform((v) => {
    return new PutMediasMoveForbiddenError(v, {
      request: v.request$,
      response: v.response$,
      body: v.body$,
    });
...
export const PutMediasMoveUnauthorizedError$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  code: operations.PutMediasMoveCode$inboundSchema.optional(),
  error: z.string().optional(),
  request$: z.instanceof(Request),
  response$: z.instanceof(Response),
  body$: z.string(),
