 ...
 */
export type PutMediasMediaHashedIdSwapForbiddenErrorData = {
  error?: string | undefined;
};
 ...
 * Forbidden, token is valid but account does not have access to feature
 */
export class PutMediasMediaHashedIdSwapForbiddenError extends WistiaError {
  error?: string | undefined;

  /** The original data that was passed to this error instance. */
  data$: PutMediasMediaHashedIdSwapForbiddenErrorData;

  constructor(
    err: PutMediasMediaHashedIdSwapForbiddenErrorData,
    httpMeta: { response: Response; request: Request; body: string },
  ) {
    const message = "message" in err && typeof err.message === "string"
      ? err.message
    ...
    this.name = "PutMediasMediaHashedIdSwapForbiddenError";
  }
}
...
export type PutMediasMediaHashedIdSwapUnauthorizedErrorData = {
   ...
   */
  code?: operations.PutMediasMediaHashedIdSwapCode | undefined;
  error?: string | undefined;
};
...
/** @internal */
export const PutMediasMediaHashedIdSwapForbiddenError$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  .transform((v) => {
    return new PutMediasMediaHashedIdSwapForbiddenError(v, {
      request: v.request$,
      response: v.response$,
      body: v.body$,
    });
...
export const PutMediasMediaHashedIdSwapUnauthorizedError$inboundSchema:
  z.ZodType<
    ...
    unknown
  > = z.object({
    code: operations.PutMediasMediaHashedIdSwapCode$inboundSchema.optional(),
    error: z.string().optional(),
    request$: z.instanceof(Request),
    response$: z.instanceof(Response),
    body$: z.string(),
