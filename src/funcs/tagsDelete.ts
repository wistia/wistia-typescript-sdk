...
import { DeleteTagsNameServerList } from "../models/operations/deletetagsname.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteTagsNameRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteTagsNameServerList[0], { charEncoding: "percent" })();
