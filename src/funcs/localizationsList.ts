...
import { GetMediasMediaHashedIdLocalizationsServerList } from "../models/operations/getmediasmediahashedidlocalizations.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMediasMediaHashedIdLocalizationsRequest$outboundSchema
        .parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetMediasMediaHashedIdLocalizationsServerList[0], {
