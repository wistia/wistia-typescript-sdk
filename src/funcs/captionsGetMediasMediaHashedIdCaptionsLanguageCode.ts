...
export enum GetMediasMediaHashedIdCaptionsLanguageCodeAcceptEnum {
 ...
 * ```
 */
export function captionsGetMediasMediaHashedIdCaptionsLanguageCode(
  client: WistiaCore,
  request: operations.GetMediasMediaHashedIdCaptionsLanguageCodeRequest,
  options?: RequestOptions & {
    acceptHeaderOverride?: GetMediasMediaHashedIdCaptionsLanguageCodeAcceptEnum;
  },
): APIPromise<
  Result<
