...
import { PostMediasMediaHashedIdCopyServerList } from "../models/operations/postmediasmediahashedidcopy.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostMediasMediaHashedIdCopyRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PostMediasMediaHashedIdCopyServerList[0], {
  ...
  const path = pathToFunc("/medias/{media-hashed-id}/copy")(pathParams);
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "post_/medias/{media-hashed-id}/copy",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostMediasMediaHashedIdCopyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(
