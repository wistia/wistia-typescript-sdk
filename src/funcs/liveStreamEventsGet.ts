...
import { GetLiveStreamEventsIdServerList } from "../models/operations/getlivestreameventsid.js";
 ...
 * ```
 */
export function liveStreamEventsGet(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetLiveStreamEventsIdRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetLiveStreamEventsIdServerList[0], {
