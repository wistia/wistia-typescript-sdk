 ...
 * <!-- /HIDE-MCP -->
 */
export function folderSharingsPutFoldersFolderIdSharingsSharingId(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutFoldersFolderIdSharingsSharingIdRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.PutFoldersFolderIdSharingsSharingIdResponse$inboundSchema,
    ),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      404,
      errors.PutFoldersFolderIdSharingsSharingIdNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors
        .PutFoldersFolderIdSharingsSharingIdInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
