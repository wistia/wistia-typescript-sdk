...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostWebinarsWebinarIdCollaboratorsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "post_/webinars/{webinarId}/collaborators",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      201,
      operations.PostWebinarsWebinarIdCollaboratorsResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.PostWebinarsWebinarIdCollaboratorsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      404,
      errors.PostWebinarsWebinarIdCollaboratorsNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors
        .PostWebinarsWebinarIdCollaboratorsInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
