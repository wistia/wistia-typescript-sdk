...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutChannelsChannelHashedIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PutChannelsChannelHashedIdResponse$inboundSchema),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      500,
      errors.PutChannelsChannelHashedIdInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
