...
import { GetChannelsChannelHashedIdChannelEpisodesChannelEpisodeIdServerList } from "../models/operations/getchannelschannelhashedidchannelepisodeschannelepisodeid.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(
      GetChannelsChannelHashedIdChannelEpisodesChannelEpisodeIdServerList[0],
