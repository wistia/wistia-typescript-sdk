...
import { GetStatsEventsServerList } from "../models/operations/getstatsevents.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStatsEventsRequest$outboundSchema.optional().parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetStatsEventsServerList[0], { charEncoding: "percent" })();
