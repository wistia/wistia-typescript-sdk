 ...
 * ```
 */
export function foldersCopy(
  client: WistiaCore,
  request: operations.PostFoldersIdCopyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostFoldersIdCopyResponse,
    | errors.PostFoldersIdCopyUnauthorizedError
    | errors.PostFoldersIdCopyNotFoundError
    | errors.PostFoldersIdCopyInternalServerError
    | WistiaError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostFoldersIdCopyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.PostFoldersIdCopyResponse$inboundSchema),
    M.jsonErr(401, errors.PostFoldersIdCopyUnauthorizedError$inboundSchema),
    M.jsonErr(404, errors.PostFoldersIdCopyNotFoundError$inboundSchema),
    M.jsonErr(500, errors.PostFoldersIdCopyInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
