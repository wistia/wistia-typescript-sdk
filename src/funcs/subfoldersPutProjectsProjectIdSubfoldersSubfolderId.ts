...
import { PutProjectsProjectIdSubfoldersSubfolderIdServerList } from "../models/operations/putprojectsprojectidsubfolderssubfolderid.js";
 ...
 * ```
 */
export function subfoldersPutProjectsProjectIdSubfoldersSubfolderId(
  client: WistiaCore,
  ...
  Result<
    ...
    | errors.PutProjectsProjectIdSubfoldersSubfolderIdNotFoundError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutProjectsProjectIdSubfoldersSubfolderIdRequest$outboundSchema
        .parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PutProjectsProjectIdSubfoldersSubfolderIdServerList[0], {
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "put_/projects/{project-id}/subfolders/{subfolder-id}",
    oAuth2Scopes: [],
