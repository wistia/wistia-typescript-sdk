...
import { PostMediasMediaHashedIdCaptionsServerList } from "../models/operations/postmediasmediahashedidcaptions.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostMediasMediaHashedIdCaptionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PostMediasMediaHashedIdCaptionsServerList[0], {
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "post_/medias/{media-hashed-id}/captions",
    oAuth2Scopes: [],
