...
import { PostMediasMediaHashedIdTrimsServerList } from "../models/operations/postmediasmediahashedidtrims.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostMediasMediaHashedIdTrimsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PostMediasMediaHashedIdTrimsServerList[0], {
