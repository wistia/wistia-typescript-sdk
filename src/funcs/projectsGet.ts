...
import { GetProjectsIdServerList } from "../models/operations/getprojectsid.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetProjectsIdServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProjectWithMedias$inboundSchema),
