 ...
 * ```
 */
export function liveStreamEventsDelete(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteLiveStreamEventsIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteLiveStreamEventsIdResponse$inboundSchema),
    M.jsonErr(
      401,
