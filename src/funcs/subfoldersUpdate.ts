...
export function subfoldersUpdate(
  ...
  Result<
    operations.PutProjectsProjectIdSubfoldersSubfolderIdResponse,
    | errors.PutProjectsProjectIdSubfoldersSubfolderIdUnauthorizedError
    | errors.PutProjectsProjectIdSubfoldersSubfolderIdNotFoundError
    | errors.PutProjectsProjectIdSubfoldersSubfolderIdInternalServerError
    | WistiaError
