...
import { PostChannelsChannelHashedIdChannelEpisodesServerList } from "../models/operations/postchannelschannelhashedidchannelepisodes.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PostChannelsChannelHashedIdChannelEpisodesServerList[0], {
