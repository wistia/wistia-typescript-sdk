...
import { GetAllowedDomainsServerList } from "../models/operations/getalloweddomains.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllowedDomainsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAllowedDomainsServerList[0], {
