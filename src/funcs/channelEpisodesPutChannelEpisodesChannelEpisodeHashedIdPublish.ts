 ...
 * ```
 */
export function channelEpisodesPutChannelEpisodesChannelEpisodeHashedIdPublish(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .PutChannelEpisodesChannelEpisodeHashedIdPublishRequest$outboundSchema
        .parse(value),
  ...
  >(
    ...
    M.jsonErr(
      500,
      errors
        .PutChannelEpisodesChannelEpisodeHashedIdPublishInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
