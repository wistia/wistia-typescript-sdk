...
export function projectsList(
  ...
  Result<
    Array<operations.GetProjectsResponse>,
    | errors.GetProjectsUnauthorizedError
    | errors.GetProjectsInternalServerError
    | WistiaError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(operations.GetProjectsResponse$inboundSchema)),
    M.jsonErr(401, errors.GetProjectsUnauthorizedError$inboundSchema),
    M.jsonErr(500, errors.GetProjectsInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
