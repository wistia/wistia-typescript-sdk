 ...
 * ```
 */
export function allowedDomainsDeleteAllowedDomainsDomain(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteAllowedDomainsDomainRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteAllowedDomainsDomainResponse$inboundSchema),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      404,
      errors.DeleteAllowedDomainsDomainNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.DeleteAllowedDomainsDomainInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
