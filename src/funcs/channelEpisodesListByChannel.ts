...
import { GetChannelsChannelHashedIdChannelEpisodesServerList } from "../models/operations/getchannelschannelhashedidchannelepisodes.js";
 ...
 * ```
 */
export function channelEpisodesListByChannel(
  client: WistiaCore,
  request: operations.GetChannelsChannelHashedIdChannelEpisodesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.ChannelEpisode>,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetChannelsChannelHashedIdChannelEpisodesServerList[0], {
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "get_/channels/{channel-hashed-id}/channel_episodes",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ChannelEpisode$inboundSchema)),
