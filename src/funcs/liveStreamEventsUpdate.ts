 ...
 * ```
 */
export function liveStreamEventsUpdate(
  client: WistiaCore,
  ...
  Result<
    ...
    | errors.PutLiveStreamEventsIdForbiddenError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutLiveStreamEventsIdRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(403, errors.PutLiveStreamEventsIdForbiddenError$inboundSchema),
    M.jsonErr(
      422,
