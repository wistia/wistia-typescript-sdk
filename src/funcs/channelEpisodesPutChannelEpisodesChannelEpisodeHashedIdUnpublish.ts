 ...
 * ```
 */
export function channelEpisodesPutChannelEpisodesChannelEpisodeHashedIdUnpublish(
  client: WistiaCore,
  request: operations.PutChannelEpisodesChannelEpisodeHashedIdUnpublishRequest,
...
> {
  ...
  const pathParams = {
    channelEpisodeHashedId: encodeSimple(
      "channelEpisodeHashedId",
      payload.channelEpisodeHashedId,
  ...
  >(
    ...
    M.jsonErr(
      500,
      errors
        .PutChannelEpisodesChannelEpisodeHashedIdUnpublishInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
