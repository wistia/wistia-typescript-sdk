...
import { GetChannelsChannelHashedIdServerList } from "../models/operations/getchannelschannelhashedid.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetChannelsChannelHashedIdRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetChannelsChannelHashedIdServerList[0], {
