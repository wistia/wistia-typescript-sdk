...
import { DeleteProjectsProjectIdSubfoldersSubfolderIdServerList } from "../models/operations/deleteprojectsprojectidsubfolderssubfolderid.js";
 ...
 * ```
 */
export function subfoldersDeleteProjectsProjectIdSubfoldersSubfolderId(
  client: WistiaCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteProjectsProjectIdSubfoldersSubfolderIdServerList[0], {
