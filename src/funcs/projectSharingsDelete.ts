...
import { DeleteProjectsProjectIdSharingsSharingIdServerList } from "../models/operations/deleteprojectsprojectidsharingssharingid.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteProjectsProjectIdSharingsSharingIdServerList[0], {
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "delete_/projects/{project-id}/sharings/{sharing-id}",
    oAuth2Scopes: [],
