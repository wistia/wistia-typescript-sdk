...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostTaggingsBulkCreateRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/taggings/bulk_create")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PostTaggingsBulkCreateResponse$inboundSchema),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      500,
      errors.PostTaggingsBulkCreateInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
