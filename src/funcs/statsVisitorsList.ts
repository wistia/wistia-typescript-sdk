...
import { GetStatsVisitorsServerList } from "../models/operations/getstatsvisitors.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStatsVisitorsRequest$outboundSchema.optional().parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetStatsVisitorsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.Visitor$inboundSchema)),
