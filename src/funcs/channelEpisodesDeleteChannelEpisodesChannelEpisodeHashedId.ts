 ...
 * ```
 */
export function channelEpisodesDeleteChannelEpisodesChannelEpisodeHashedId(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .DeleteChannelEpisodesChannelEpisodeHashedIdRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations
        .DeleteChannelEpisodesChannelEpisodeHashedIdResponse$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
    ...
    M.jsonErr(
      500,
      errors
        .DeleteChannelEpisodesChannelEpisodeHashedIdInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
