...
import { GetChannelsServerList } from "../models/operations/getchannels.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetChannelsRequest$outboundSchema.optional().parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetChannelsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.Channel$inboundSchema)),
