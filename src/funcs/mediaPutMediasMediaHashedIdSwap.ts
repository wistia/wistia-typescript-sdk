 ...
 * ```
 */
export function mediaPutMediasMediaHashedIdSwap(
  client: WistiaCore,
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors.PutMediasMediaHashedIdSwapNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.PutMediasMediaHashedIdSwapInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
