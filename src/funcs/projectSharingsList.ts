 ...
 * ```
 */
export function projectSharingsList(
  client: WistiaCore,
  request: operations.GetProjectsProjectIdSharingsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.GetProjectsProjectIdSharingsResponse>,
    | errors.GetProjectsProjectIdSharingsUnauthorizedError
    | errors.GetProjectsProjectIdSharingsInternalServerError
    | WistiaError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetProjectsProjectIdSharingsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      z.array(operations.GetProjectsProjectIdSharingsResponse$inboundSchema),
    ),
    M.jsonErr(
      401,
      errors.GetProjectsProjectIdSharingsUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.GetProjectsProjectIdSharingsInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
