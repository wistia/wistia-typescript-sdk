 ...
 * <!--- /HIDE-MCP -->
 */
export function statsVisitorsGetStatsVisitorsVisitorKey(
  client: WistiaCore,
  ...
  Result<
    ...
    | errors.GetStatsVisitorsVisitorKeyForbiddenError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.GetStatsVisitorsVisitorKeyForbiddenError$inboundSchema,
    ),
    M.jsonErr(
      500,
