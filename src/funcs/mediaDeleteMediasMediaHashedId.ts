 ...
 * ```
 */
export function mediaDeleteMediasMediaHashedId(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteMediasMediaHashedIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteMediasMediaHashedIdResponse$inboundSchema),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      500,
      errors.DeleteMediasMediaHashedIdInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
