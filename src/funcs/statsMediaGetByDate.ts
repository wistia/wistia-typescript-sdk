...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStatsMediasMediaIdByDateRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      z.array(operations.GetStatsMediasMediaIdByDateResponse$inboundSchema),
    ),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      500,
      errors.GetStatsMediasMediaIdByDateInternalServerError$inboundSchema,
    ),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
