...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteChannelsChannelHashedIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteChannelsChannelHashedIdResponse$inboundSchema),
    M.jsonErr(
      401,
    ...
    M.jsonErr(
      500,
      errors.DeleteChannelsChannelHashedIdInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
