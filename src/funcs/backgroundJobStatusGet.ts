...
import { GetBackgroundJobStatusBackgroundJobStatusIdServerList } from "../models/operations/getbackgroundjobstatusbackgroundjobstatusid.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetBackgroundJobStatusBackgroundJobStatusIdServerList[0], {
