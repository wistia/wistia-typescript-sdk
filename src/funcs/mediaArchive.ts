...
import { PutMediasArchiveServerList } from "../models/operations/putmediasarchive.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PutMediasArchiveRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PutMediasArchiveServerList[0], { charEncoding: "percent" })();
