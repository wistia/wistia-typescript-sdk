 ...
 * ```
 */
export function channelEpisodesPutChannelEpisodesChannelEpisodeHashedId(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutChannelEpisodesChannelEpisodeHashedIdRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.PutChannelEpisodesChannelEpisodeHashedIdResponse$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
    ...
    M.jsonErr(
      500,
      errors
        .PutChannelEpisodesChannelEpisodeHashedIdInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
