 ...
 * ```
 */
export function projectSharingsGetProjectsProjectIdSharings(
  client: WistiaCore,
  request: operations.GetProjectsProjectIdSharingsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.ProjectSharingDetail>,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ProjectSharingDetail$inboundSchema)),
