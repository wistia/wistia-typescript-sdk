...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostChannelsChannelHashedIdCollaboratorsRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "post_/channels/{channelHashedId}/collaborators",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      201,
      operations.PostChannelsChannelHashedIdCollaboratorsResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors
        .PostChannelsChannelHashedIdCollaboratorsBadRequestError$inboundSchema,
    ),
    M.jsonErr(
      401,
      errors
    ...
    M.jsonErr(
      404,
      errors
        .PostChannelsChannelHashedIdCollaboratorsNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors
        .PostChannelsChannelHashedIdCollaboratorsInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
