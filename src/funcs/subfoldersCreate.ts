...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostFoldersFolderIdSubfoldersRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors.PostFoldersFolderIdSubfoldersNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      500,
      errors.PostFoldersFolderIdSubfoldersInternalServerError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
