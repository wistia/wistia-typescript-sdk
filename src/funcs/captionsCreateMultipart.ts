...
import { PostMediasMediaHashedIdCaptionsMultipartServerList } from "../models/operations/postmediasmediahashedidcaptionsmultipart.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostMediasMediaHashedIdCaptionsMultipartRequest$outboundSchema
        .parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PostMediasMediaHashedIdCaptionsMultipartServerList[0], {
  ...
  const path = pathToFunc("/medias/{media-hashed-id}/captions")(pathParams);
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "post_/medias/{media-hashed-id}/captions_multipart",
    oAuth2Scopes: [],
