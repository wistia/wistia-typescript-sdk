...
import { PostProjectsProjectIdSubfoldersServerList } from "../models/operations/postprojectsprojectidsubfolders.js";
 ...
 * ```
 */
export function subfoldersPostProjectsProjectIdSubfolders(
  client: WistiaCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PostProjectsProjectIdSubfoldersServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.Subfolder$inboundSchema),
