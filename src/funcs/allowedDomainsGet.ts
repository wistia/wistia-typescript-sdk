...
import { GetAllowedDomainsDomainServerList } from "../models/operations/getalloweddomainsdomain.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAllowedDomainsDomainServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AllowedDomain$inboundSchema),
