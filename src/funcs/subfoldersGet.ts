...
export function subfoldersGet(
  ...
  Result<
    operations.GetProjectsProjectIdSubfoldersSubfolderIdResponse,
    | errors.GetProjectsProjectIdSubfoldersSubfolderIdUnauthorizedError
    | errors.GetProjectsProjectIdSubfoldersSubfolderIdNotFoundError
    | errors.GetProjectsProjectIdSubfoldersSubfolderIdInternalServerError
    | WistiaError
