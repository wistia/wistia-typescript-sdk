...
import { GetProjectsProjectIdSubfoldersServerList } from "../models/operations/getprojectsprojectidsubfolders.js";
 ...
 * ```
 */
export function subfoldersGetProjectsProjectIdSubfolders(
  client: WistiaCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetProjectsProjectIdSubfoldersServerList[0], {
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "get_/projects/{project-id}/subfolders",
    oAuth2Scopes: [],
