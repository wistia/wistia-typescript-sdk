...
import { PostMediasMediaHashedIdTranslateServerList } from "../models/operations/postmediasmediahashedidtranslate.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(PostMediasMediaHashedIdTranslateServerList[0], {
  ...
  const path = pathToFunc("/medias/{media-hashed-id}/translate")(pathParams);
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "post_/medias/{media-hashed-id}/translate",
    oAuth2Scopes: [],
