...
import { GetMediasMediaHashedIdCaptionsServerList } from "../models/operations/getmediasmediahashedidcaptions.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMediasMediaHashedIdCaptionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetMediasMediaHashedIdCaptionsServerList[0], {
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "get_/medias/{media-hashed-id}/captions",
    oAuth2Scopes: [],
