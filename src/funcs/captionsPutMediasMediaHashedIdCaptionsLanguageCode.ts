 ...
 * ```
 */
export function captionsPutMediasMediaHashedIdCaptionsLanguageCode(
  client: WistiaCore,
  ...
  Result<
    void,
    | errors.PutMediasMediaHashedIdCaptionsLanguageCodeUnauthorizedError
    | errors.PutMediasMediaHashedIdCaptionsLanguageCodeInternalServerError
    | WistiaError
