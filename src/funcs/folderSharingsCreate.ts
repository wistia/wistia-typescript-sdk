 ...
 * ```
 */
export function folderSharingsCreate(
  client: WistiaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostFoldersFolderIdSharingsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostFoldersFolderIdSharingsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(
    ...
    M.jsonErr(
      500,
      errors.PostFoldersFolderIdSharingsInternalServerError$inboundSchema,
    ),
    M.fail([400, "4XX"]),
    M.fail("5XX"),
